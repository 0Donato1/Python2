...
#4 DELETE FROM ... WHERE
'''
context.Query("DELETE FROM S 2816 WHERE id = 5")
'''

#5 SELECT (set_name_of_fields) FROM ... WHERE ...
'''
res1 = context.Execute("SELECT name, avg_grade FROM S2816 WHERE avg_grade > 11.0")
res2 = context.Execute("SELECT name, age FROM S2816 WHERE age < 15.0")
res3 = context.Execute("SELECT * FROM S2816")
print(f"{res1},\n{res2}, \n{res3}")
'''
